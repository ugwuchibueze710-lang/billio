...
def _client():
    ...
    return boto3.client(
        ...
        config=Config(
            ...
            # Supabase Storage (and most non-AWS S3-compatible providers)
            # require path-style addressing -- bucket in the URL path
            # rather than as a subdomain of the endpoint.
            s3={"addressing_style": cfg.get("S3_ADDRESSING_STYLE", "path")},
        ),
    )
